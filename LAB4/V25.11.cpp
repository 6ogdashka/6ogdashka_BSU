...
#include <stdexcept>
int main () {
    int32_t size = get_array_size(size);
    const int SIZE = size;
    double* array [SIZE];
    try {
...
void quick_array_sort ( int32_t begin_index, int32_t end_index, double *array [SIZE])
{
...
void cin_array( double *array [SIZE], int32_t size) {
    for ( int i{}; i < size; ++i) {
        if (!(std::cin >> *array[i])) {
...
void handle_input (double *array [SIZE], int32_t size) {
    std::cout << " input your array: ";
    cin_array(array,size);
}

int get_array_size (int &size) {
    std::cout << "hello, enter array size, pls: ";
    if (!(std::cin >> size)) {
...
void random_generate_array(double *array [SIZE], int32_t SIZE, double left_range_of_elements, double right_range_of_element ) {
...
void random_input ( double *array [SIZE], int32_t size) {
...
void input_choice (double *array[SIZE], int32_t size) {
...
void solve ( double *array [SIZE], int32_t size) {
